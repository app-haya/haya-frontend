...
export class LandingPage {
  ...
  features = [
    ...
    { icon: 'bi-trophy', title: 'المبدعون المميزون', desc: 'تصفّح أبرز المبدعين والمؤثرين في تطبيق هيّا' },
  ...
  howItWorks = [
    ...
    { 
      ...
      icon: 'bi-chat-dots', 
      title: 'تفاعل وإشتر', 
      desc: 'كل دردشة، حجز، أو شراء<br>يمنحك نقاطاً فورية' 
    },
    { 
      step: '3', 
      icon: 'bi-collection', 
      title: 'إجمع النقاط', 
      desc: 'راقب نمو رصيد نقاطك<br>في خدمة توب 30' 
    },
    { 
      step: '4', 
      icon: 'bi-box-arrow-in-right', 
      title: 'أدخل التحدي', 
      desc: 'نافس للوصول إلى <br>أفضل 30 مستخدماً في منطقتك' 
    },
    { 
      step: '5', 
      icon: 'bi-trophy', 
      title: 'إربح الجوائز', 
      desc: 'جوائز حصرية ومكاسب حقيقية<br>لأفضل المتفاعلين' 
    }
  ];
  ...
  topUsers = [
    ...
    },
    {
      ...
      desc: 'التاجر هو المحرك حيث يقدم النقاط كمكافأة للعملاء<br>عند الشراء أو إستخدام الخدمات عبر API هيّا'
    }
  ];
  ...
  whyHaya = [
    ...
    { icon: 'bi-flag', title: 'هوية فريدة', desc: 'إستخدام التراث النجدي كقوة ناعمة في<br>التصميم والتقنية' },
  ];
