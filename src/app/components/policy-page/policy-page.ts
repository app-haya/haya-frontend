...
export class PolicyPage implements OnInit {
  ...
  loadContent() {
    ...
    if (this.type === 'terms') {
      ...
      this.content = `يوفر تطبيق هيّا واجهة برمجة تطبيقات (API) تتيح للمتاجر الإلكترونية ربط أنظمتها مباشرة مع التطبيق، مما يساهم في إدارة المنتجات والطلبات بشكل آلي وسلس.
...
يمكنك الاطلاع على دليل الربط التقني للحصول على التفاصيل البرمجية الكاملة.
